            ...
            <div className="row my-auto">
                ...
                <div className="resume-item col-md-6 col-sm-12 " > 
                    ...
                    <div className=" resume-content mr-auto">
                        <h4 className="mb-3"><i className="fa fa-globe mr-3 text-info"></i>WEB DEVELOPMENT</h4>
                        <p>I have experience building websites. I have developed many websites in different web technologies.
                           Usually working on javascript stack like Node, React, Vue. I also has experince in laravel.
                        </p>
                    </div>
